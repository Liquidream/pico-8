...
-- object data
local obj_data=[[id|obj_spr|map_spr|my|ico_spr|type|w|h|z|trans_col|parent_id|parent2_id|owner|col1|col2|icol1|icol2|ico_w|ico_h|req_id|req_faction|max|cost|power|arms|hitpoint|speed|range|fire_type|fire_size|fire_rate|fire_sfx|death_sfx|norotate|altframe|framecount|life|process|spent|fire_cooldown|hit|flash_count|col_cycle_pos|col_cycle_src|storage|capacity|is_repairable|ai_build|ai_priority|moves|tracked|on_foot|is_building|is_unit|is_dockable|capturable|can_fire|can_capture|can_smoke|soldiers_on_destroy|shad_w|shad_h|fow_range|is_limit_capped|req_level|col_cycle|name|description|func_draw|func_onclick
1|64|64||170|2|2|2|0||nil|||||||2|2|1|||100|0||400|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|30|nil||nil|1|nil|nil|1|nil||1|1|||3|nil|1,1,1,1||cONSTRUCTION yARD|aLL STRUCTURES ARE~BUILT BY THE~CONSTRUCTION YARD.||factory_click
...
5|61|61||228|2|3|3|0||1|||||11|3|2|2|17||1|500|50||500|0||||||53|nil||8|0|0|0|0|0|1|1|11|0|nil|1|nil|25|nil||nil|1|nil|nil|1|nil||1|1|||5|1|6,6,6,6|11,10,8,8|sTARPORT|tHE sTARPORT IS USED TO~ORDER AND RECEIVE~SHIPMENTS FROM~c.h.o.a.m.|draw_refinery|factory_click
6|101|101||166|2|3|2|0||1|||||||2|2|14|||500|35||400|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|20|nil||nil|1|nil|nil|1|nil||1|1|||4|1|5,5,5,5||hI-tECH fACTORY|tHE hI-tECH fACTORY~PRODUCES FLYING~VEHICLES.||factory_click
7|98|98||142|2|3|2|0||1|||||||2|2|14|||600|20||200|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|60|nil||nil|1|nil|nil|1|nil||1|1|||4|1|4,4,4,4||hEAVY vEHICLE fACTORY|tHE hEAVY fACTORY~PRODUCES HEAVY ATTACK~VEHICLES.||factory_click
...
11|110|110||138|2|2|2|0||1|||||||2|2|16|-1||400|10||400|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|17.5|nil||nil|1|nil|nil|nil|nil||1|1|||4|1|4,4,2,4||wor tROOPER fACILITY|wor IS USED TO TRAIN~YOUR hEAVY INFANTRY.||factory_click
12|108|108||168|2|2|2|0||1|||||11|3|2|2|16|-3||300|10||300|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|10|nil||nil|1|nil|nil|nil|nil||1|1|||3|1|2,2,2,2||bARRACKS|tHE bARRACKS IS USED TO~TRAIN YOUR lIGHT ~INFANTRY.||factory_click
...
14|96|96||140|2|2|2|0||1|||||||2|2|17|||400|20||350|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|20|nil||nil|1|nil|nil|1|nil||1|1|||4|1|2,2,3,2||lIGHT vEHICLE fACTORY|tHE lIGHT fACTORY~PRODUCES LIGHT ATTACK~VEHICLES.||factory_click
...
17|68|68||174|2|3|2|0||1|||||||2|2|18|||400|30||450|0||||||53|nil||8|0|0|0|0|0|1|1|11|1000|nil|1|nil|30|nil||nil|1|nil|1|1|nil||1|1|||4|1|1,1,1,1|11,10,8,8|sPICE rEFINERY|tHE rEFINERY CONVERTS~SPICE INTO CREDITS.|draw_refinery|
...
80|3|3||3|3|1|1|0|11||||||||1|1|||||||0|0|||||||nil|||0|0|0|0|0|1|1||0|nil|nil|nil||nil|||nil|nil|nil|||nil|nil|nil||||nil|1,1,1,1||rEPAIR||draw_action|action_click
81|1|1||1|3|1|1|0|11||||||||1|1||9|||||0|0|||||||nil|||0|0|0|0|0|1|1||0|nil|nil|nil||nil|||nil|nil|nil|||nil|nil|nil||||nil|1,1,1,1||lAUNCH||draw_action|action_click]]
...
function _init()
 ...
 worker_cor = cocreate(function()
  ...
  if t_%30==0 then
   ...
   -- update "blocker" pos's
   object_tiles={}
   for unit in all(units) do
    object_tiles[get_tile_pos_index(unit)]=unit
   end

   local new_radar_data,off,offset,mval = {},0,40
   -- landscape/fow
   if hq then
    for i=0,62,2 do
      for l=0,62,2 do
       local mspr_off=wrap_mget(i,l)*8
       if(fow[i][l]>0) new_radar_data[(i/2)..","..(l/2)] = mspr_off>0 and sget(mspr_off%128+3, mspr_off\128*8+3) or 15
      end
      yield()
    end
   end  
   ...
   power_bal,total_storage,building_count,has_obj,unit_count = 0,0,{0,0},{{},{}},split"0,0,0,0"
   ...
   for unit in all(units) do
    ...
    if (unit.is_limit_capped) unit_count[unit.faction]+=1
   end
  
   -- has radar + enough power?
      ...
      add(newobj.build_objs,
        m_obj_from_ref(o, 107,0, 5, newobj, nil, nil, function(self)
          ...
          if show_menu then
            ...
            if self.is_building and #buildings<150 or self.is_unit and unit_count[new_faction]<20 then
             --auto build
  ...
  get_hitbox=function(self)
   ...
   update=function(self)
     ...
     if self.hit>0 and self.created_by>0 and id!=43 then        
       ...
       -- lose soldiers
       if (self.on_foot and life<25) self.spr_w,self.spr_h=.5,.5
       -- can we retaliate?
     ...
     if self.death_time then
      ...
      if self.death_time<=0 then
        if in_type==2 then         
         ...
         for xx=0,self.spr_w-1 do
           for yy=0,self.spr_h-1 do
             ...
             -- create soldiers
             if (self.soldiers_on_destroy and #units<75 and chance"2") m_map_obj_tree(obj_data[23.5],self.x+xx*8,self.y+yy*8,self.owner,self)
           end
         end
         del(buildings,self)
        ...
        -- dying
        if (not self.on_foot) make_explosion(self.x+rnd(self.w),self.y+rnd(self.h))
      end
     end
     ...
     if self.process>0 
      ...
      elseif self.process==2 and life>self.hitpoint then
        ...
        if self.moves then
         ...
         -- go back to guard
         -- find nearest point to factory
         self.return_to.col_cycle,self.state,self.cor = {0},0,cocreate(function(unit) move_unit_pos(unit,unit.gx\8,unit.gy\8,0,true) end)
    ...
    if self.state==9 then
     ...
     if last_fact.life>0 and not last_fact.occupied and self.life>0 then      
      ...
      if self.capacity and last_fact.id==17 then 
       ...
       self.capacity,self.state,self.name,last_fact.occupied = 0,0,"hARVESTER (0%)"
       if self.sx then 
...
function do_attack(unit, target, manual_attack)
 ...
 if id!=19 then 
   ...
   while target.life>0 and target.state!=8 do
    ...
    yield()
    -- thopters only fire once/attack
    -- (+all units abort attack if unit=converted to "our" side)
    if (id==33 or target.faction==unit.faction) break
   end -- 4) repeat until destroyed
...
function move_unit_pos(unit,x,y,dist_to_keep,try_hail,start_state)
  ...
  if try_hail then
   ...
   if carryall and not carryall.link and carryall.faction==unit.faction then
     -- link them + wait for pickup
     carryall.link,unit.link,carryall.cor = unit,carryall,cocreate(function(unit_c)     
      move_unit_pos(unit_c,unit.x\8,unit.y\8)
      deselect_check(unit)
      if unit.life>0 then
       carryall.my,unit.state = 18,8 --(state=repairing/unloading to stop being hit)
       del(units,unit)
   ...
   while frontier_len > 0 do
    ...
    for xx = -1, 1 do
     for yy = -1, 1 do
      ...
      if (xx!=0 or yy!=0)
       --maybe_add
       and unit.flying or not fget(wrap_mget(nx,ny),0)
...
__map__

...

...

