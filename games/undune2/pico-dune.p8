...
-- object data
local obj_data=[[id|obj_spr|map_spr|my|ico_spr|type|w|h|z|trans_col|parent_id|parent2_id|owner|col1|col2|icol1|icol2|ico_w|ico_h|req_id|req_level|req_faction|max|cost|power|arms|hitpoint|speed|range|fire_type|fire_rate|fire_sfx|death_sfx|norotate|altframe|framecount|life|process|spent|fire_cooldown|hit|flash_count|col_cycle_pos|col_cycle_src|storage|capacity|is_repairable|ai_build|moves|tracked|onfoot|is_building|is_unit|is_dockable|capturable|can_capture|can_smoke|soldiers_on_destroy|col_cycle|name|description|func_draw|func_onclick
...
37|56|56|28|200|1|1|1|1|11|12|||12||||2|2|18|8|3||800||320|1600|0.06666666667|8|1|33|58|54|nil|||0|0|0|0|0|1|1||0|nil|1|1|1|1|nil|nil|1|nil||nil|1|nil||dEVASTATOR|tHE dEVESTATOR IS A~NUCLEAR-POWERED TANK,~WHICH FIRES DUAL PLASMA~CHARGES. mOST POWERFUL~TANK ON dUNE, BUT~POTENTIALLY UNSTABLE~IN COMBAT.||
     ...
     if self.death_time then
      ...
      if self.death_time<=0 then
        if in_type==2 then         
         ...
         if (self.soldiers_on_destroy) m_map_obj_tree(obj_data[rnd{20,22}],self.x,self.y,self.owner,self)         
        else
         -- unit
...
bebbbebbbebbbebbedeccccebb6ccdebb6cccdebbeccddcbbe076dcbbecd66dcb807c288be9ddcebd5555555555554a904455555dfff4144f54499999445f66f
...
bbb7bbbbbbb7bbbbcecccccebb6ccdebb6cccdebbeccddcbbe076dcb0666777db807c288be9ddceb4a042499999442424297a094dffffffff5424444424556d5
...
__map__

...

...

...

