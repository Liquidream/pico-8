...
if(object.owner!=1 and object.state!=4) return
 ...
 local size,x,y=object.type+3,get_tile_pos(object)
 for xx=-size,size do
  for yy=-size,size do
   local posx,posy = x+xx,y+yy
   if (dist(x,y,posx,posy)<2.5) then
    fow[posx][posy]=16
    for dy=-1,1 do
     for dx=-1,1 do
...

