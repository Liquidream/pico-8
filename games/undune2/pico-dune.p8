  ...
  get_hitbox=function(self)
   ...
   update=function(self)
     ...
     if self.hit>0 and self.created_by>0 then 
       ...
       -- req repair pickup
       if (life<50 and self.state!=7) return_to_fact(self,safe_rnd(has_obj[self.created_by][14]) or self.last_fact)
     end
     -- check for death
     ...
     if self.bullet_x then
      ...
      then
       ...
       then
        ...
        -- deviator specific
        if id==40 and target.speed!=nil then
