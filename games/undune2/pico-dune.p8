...
-- object data
local obj_data=[[id|obj_spr|map_spr|my|ico_spr|type|w|h|z|trans_col|parent_id|parent2_id|owner|col1|col2|icol1|icol2|ico_w|ico_h|req_id|req_faction|max|cost|power|arms|hitpoint|speed|range|fire_type|fire_size|fire_rate|fire_sfx|death_sfx|norotate|altframe|framecount|life|process|spent|fire_cooldown|hit|flash_count|col_cycle_pos|col_cycle_src|storage|capacity|is_repairable|ai_build|ai_priority|moves|tracked|on_foot|is_building|is_unit|is_dockable|capturable|can_fire|can_capture|can_smoke|soldiers_on_destroy|shad_w|shad_h|req_level|col_cycle|name|description|func_draw|func_onclick
1|64|64||170|2|2|2|0||nil|||||||2|2|1|||100|0||1600|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|30|nil||nil|1|nil|nil|1|nil||1|1|||1,1,1,1||cONSTRUCTION yARD|aLL STRUCTURES ARE~BUILT BY THE~CONSTRUCTION YARD.||factory_click
...
6|68|68||174|2|3|2|0||1|||||||2|2|5|||400|30||1800|0||||||53|nil||8|0|0|0|0|0|1|1|11|1000|nil|1|nil|30|nil||nil|1|nil|1|1|nil||1|1|||1,1,1,1|11,10,8,8|sPICE rEFINERY|tHE rEFINERY CONVERTS~SPICE INTO CREDITS.|draw_refinery|
...
9|108|108||168|2|2|2|0||1|||||11|3|2|2|7|-3||300|10||1200|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|10|nil||nil|1|nil|nil|nil|nil||1|1|||2,2,2,2||bARRACKS|tHE bARRACKS IS USED TO~TRAIN YOUR lIGHT ~INFANTRY.||factory_click
10|110|110||138|2|2|2|0||1|||||||2|2|7|-1||400|10||1600|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|17.5|nil||nil|1|nil|nil|nil|nil||1|1|||5,5,2,5||wor tROOPER fACILITY|wor IS USED TO TRAIN~YOUR hEAVY INFANTRY.||factory_click
11|96|96||140|2|2|2|0||1|||||||2|2|6|||400|20||1400|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|20|nil||nil|1|nil|nil|1|nil||1|1|||2,2,3,2||lIGHT vEHICLE fACTORY|tHE lIGHT fACTORY~PRODUCES LIGHT ATTACK~VEHICLES.||factory_click
12|98|98||142|2|3|2|0||1|||||||2|2|11|||600|20||800|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|60|nil||nil|1|nil|nil|1|nil||1|1|||3,3,3,3||hEAVY vEHICLE fACTORY|tHE hEAVY fACTORY~PRODUCES HEAVY ATTACK~VEHICLES.||factory_click
13|101|101||166|2|3|2|0||1|||||||2|2|12|||500|35||1600|0||||||53|nil|||0|0|0|0|0|1|1||0|nil|1|nil|20|nil||nil|1|nil|nil|1|nil||1|1|||5,5,5,5||hI-tECH fACTORY|tHE hI-tECH fACTORY~PRODUCES FLYING~VEHICLES.||factory_click
...
17|61|61||228|2|3|3|0||1|||||11|3|2|2|6||1|500|50||2000|0||||||53|nil||8|0|0|0|0|0|1|1|11|0|nil|1|nil|25|nil||nil|1|nil|nil|1|nil||1|1|||6,6,6,6|11,10,8,8|sTARPORT|tHE sTARPORT IS USED TO~ORDER AND RECEIVE~SHIPMENTS FROM~c.h.o.a.m.|draw_refinery|factory_click
...
34|20|40|20|160|1|1|1|4|11|13|||||||2|2|18|-3||600|0|296|4|1|7|2|1.9|33|59|54|nil|22|8|0|0|0|0|0|1|1||0|nil|nil|1|3|1|nil|nil|nil|1|nil||1|nil|nil|nil|6|6|7,7,7,7||oRNITHOPTER|tHE oRNITHOPTER IS A~LIGHTLY ARMOURED~AIRCRAFT THAT FIRES~ROCKETS.hIGHLY~MANOUVERABLE + FASTEST~AIRCRAFT ON dUNE.||
  ...
  if objref.is_building and not objref.is_unit then
    ...
    for xx=0,objref.w-1 do
      for yy=0,objref.h-1 do
       if not slabs or fget(wrap_mget(xpos+xx, ypos+yy),5) then
  ...
  get_hitbox=function(self)
      ...
      if self.bullet_x then      
       if self.fire_type==1 then
        ...
        add_particle(
         ...
         self.fire_size,-- and 1.9 or 0,
         0, 0, is_missile and -.3 or 1,
         0,
         is_missile and 10 or 2.5, 
         is_missile and split"7,10,9,8,2" or {15})
       end
      end
      -- smoking?
   ...
   update=function(self)
     ...
     if self.owner==1 then
      if (id==5) self.name="wINDTRAP (\|f\^:0804061f0c040200\|h\-f"..power_bal..")"
    ...
    for i=1,#selected_obj.build_objs do
     ...
     then
      ...
      if selected_subobj == curr_item then
        ...
        -- adj price
        if (selected_obj.id==17) srand(t_\3600) selected_subobj.cost=selected_subobj.ref.cost \ (rnd"0.533"+0.8)
   ...
   elseif chance"250" and self.can_fire and self.state!=8 then
    ...
    ping(self,gx,gy,
     function (unit,x,y)
      ...
      if target and target.created_by!=unit.created_by and fow[x][y]==16 and (not target.flying or unit.id==16) then
   ...
   while target.life>0 and target.state!=8 do
    ...
    if dist(unit.x,unit.y,target.x,target.y) > firing_range
     ...
     if move_unit_pos(unit,(target.x+rnd(target.w))\8,(target.y+rnd(target.h))\8,firing_range) 
      and unit.arms==1600 -- ...and IF successful AND saboteur or death hand? Boom!
     then
      unit.life=0
      for i=1,15 do
    ...
    if (id==40 or id==34 or target.faction==unit.faction or target.link) break
...
function is_free_tile(unit,x,y)
 ...
 return not fget(wrap_mget(x,y),0)
   and (not obj_tile or obj_tile==unit or obj_tile.flying or (obj_tile.on_foot and unit.tracked and obj_tile.created_by!=unit.created_by))
end
...

...

...

