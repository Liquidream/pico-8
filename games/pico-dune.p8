...
32|oRNITHOPTER|160|166|1|1|1|4|11|13|||||||13|7|-3||600||75|20|0.75|9|2|20||161|5|tHE oRNITHOPTER IS A~LIGHTLY ARMOURED~AIRCRAFT THAT FIRES~ROCKETS.hIGHLY MANOUVERABLE~+ FASTEST AIRCRAFT ON~dUNE.||||
...
function return_to_fact(unit,fact)
 printh("return_to_fact() "..unit.name..","..unit.created_by)
...
function attack_rnd_enemy(obj)
 ...
 if (p_target and enemy_visible(p_target)) do_attack(obj, p_target) --printh(obj.name.." > p_target="..p_target.name) 
end
