...
20|iNFANTRY sOLDIER|49|236|1|0.5|0.5|1|11|9|||||15|3|2|2||2|-3||60||2|100|0.05|2|1|0.5|1|48|10|iNFANTRY ARE LIGHTLY~ARMOURED FOOTSOLDIERS,~WITH LIMITED FIRING~RANGE AND SPEED.||||
...
22|hEAVY tROOPER|49|194|1|0.5|0.5|1|11|10|||||||2|2||3|-1||100||4|440|0.1|3|1|1|1|48|10|tROOPERS ARE HEAVILY~ARMOURED FOOTSOLDIERS,~WITH IMPROVED FIRING~RANGE AND SPEED.||||
 ...
 local obj={  
  ...
  get_hitbox=function(self)
   ...
   draw=func_draw or function(self)
     ...
     -- smoking?
     if (self.id>=27 and self.life<self.hitpoint*.33 and rnd"10"<1 and self.type<=2) add_particle(self.x+3.5,self.y+3.5, 1, .1,-.02,.05, -.002, 80,split2d("10,9,6,5",","), rnd"2"<1 and 0xa5a5.8 or 0)
     -- reset hit flag
     self.hit=0
   end,
...

