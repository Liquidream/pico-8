 ...
 local obj={  
  ...
  get_hitbox=function(self)
   ...
   draw=func_draw or function(self)
     ...
     -- smoking?
     if (self.life<self.hitpoint*.33 and self.altframe==nil and rnd"10"<1) add_particle(self.x+3.5,self.y+3.5, 1, .1,-.02,.05, -.002, 80,split2d("10,8,9,6,5",","), rnd"2"<1 and 0xa5a5.8 or 0)
     -- reset hit flag
     self.hit=0
   end,
