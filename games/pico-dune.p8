...
function m_map_obj_tree(objref, x,y, last_fact)
  ...
  if objref.type==2 then
    ...
    for xx=0,objref.w-(objref.id==6 and 2 or 1) do
  ...
  while true do
   ...
   if self.id==27 then
    ...
    elseif self.state==6 then
     ...
     if (rnd(5)<1) add_particle(unit.x+cx+3.5,unit.y+cy+3.5, 1, 0,0,.15, -.01, 20,{2,4,9,15},nil)
...

...

...

...

